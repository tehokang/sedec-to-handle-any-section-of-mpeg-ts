...
#ifndef __SCX_TOKENIZER_H__
#define __SCX_TOKENIZER_H__
...
public:
	SCXTokenizer();
	SCXTokenizer(const std::string& str, const std::string& delimiter=DEFAULT_DELIMITER);
	~SCXTokenizer();
